(function(testutil) {
  ...
  jshero.koans.add({
    ...
    lesson: 'Numbers are represented by simple numerals. They can have a decimal point and a minus sign.' +
      '<pre><code>let x1 = 1;<br>let x2 = 1.0;<br>let x3 = 3.14;<br>let x4 = -1;</code></pre>' +
      ...
      '<pre><code>let x1 = 6;<br>let x2 = 2;<br>let x3 = x1 + x2;<br>let x4 = x1 - x2;<br>let x5 = x1 * x2;<br>let x6 = x1 / x2;</code></pre>' +
