jshero.koans.add({
  ...
  lesson: `Wir haben gesehen, dass eine Variable ein Behälter für einen Wert ist.
Ein Wert kann ein Text wie <code>'Hallo Welt!'</code> sein. Werte besitzen dabei einen Typ.
Der Typ von <code>'Hallo Welt!'</code> ist <code>string</code>.
Um aus einem Text einen String zu machen, kann man einfache oder doppelte Anführungszeichen verwenden.
