jshero.koans.add({
  ...
  task: 'Write a function <code>nand</code> that takes two Boolean values. If both values are <code>true</code>, the result should be <code>false</code>. ' +
    'In the other cases the return should be <code>true</code>. The call <code>nand(true, true)</code> ' +
    'should return <code>false</code>. The calls <code>nand(true, false)</code>, <code>nand(false, true)</code> and <code>nand(false, false)</code> should return <code>true</code>.',
