jshero.koans.add({
  ...
  lesson: 'Die Methode <code>substr</code> extrahiert aus einen String einen Teilstring:' +
    '<pre><code>' +
    'var see = "see and stop".substr(0, 3);<br>' +
    'var and = "see and stop".substr(4, 3);<br>' +
    'var stop = "see and stop".substr(8);<br>' +
    '</code></pre>' +
    'Der erste Parameter gibt an, von welcher Stelle an der Substring extrahiert werden soll. Der zweite Parameter gibt an, wieviel Zeichen ab der festgelegten Stelle extrahiert werden sollen. ' +
