...
jshero.koans.add({
  ...
  lesson: 'Mit Schleifen können wir einen Code-Abschnitt mehrmals durchlaufen. JavaScript kennt mehrere Schleifenarten. Die einfachste ist die for-Schleife.' +
    '<pre><code>var summe = 0;<br>' +
    'for (var i = 1; i < 3; i++) {<br>' +
    '  summe = summe + i;<br>' +
    '}</code></pre>' +
    'Die for-Schleife wird über drei Anweisungen, der Start-Anweisung, einer Bedingung und einer Schleifen-Anweisung gesteuert. ' +
    'Zunächst wird die Start-Anweisung ausgeführt. Hier wird normalerweise eine Variable initialisiert. ' +
    'Wir initialisieren die Variable <code>i</code> mit dem Wert <code>1</code>. Anschließend wird die Bedingung ausgewertet. ' +
    'Ist sie <code>true</code>, wird der Schleifen-Code ausgeführt. Der Schleifen-Code steht wie bei der if-Anweisung zwischen den beiden Mengenklammern. ' +
    'Nach Ausführung des Schleifen-Codes wird die Schleifen-Anweisung ausgeführt. Hier erhöhen wir <code>i</code> um 1 ' +
    '(<code>i++</code> ist identisch mit <code>i = i + 1</code>). Anschließend wird wieder die Schleifen-Bedingung ausgewertet. ' +
    'Sobald die Bedingung <code>false</code> ergibt, wird die Schleife beendet und die Programmaudführung wird nach der Schleife fortgesetzt. ' +
    ...
    'Nun wird <code>i</code> um <code>1</code> erhöht. Es hat also den Wert <code>2</code>. Die Schleifenbedingung <code>2 < 3</code> ist immer noch erfüllt. ' +
    ...
    'Unser Codebespiel hat also alle natürlichen Zahlen echt kleiner 3 zusammen addiert.',
