...
jshero.koans.add({
  ...
  lesson: 'Bisher hatten wir Variablen bei der Deklaration immer auch initialisiert.' +
     ...
     '  return x;<br>' +
     '};<br>' +
     '// Aufruf ohne Argument<br>' +
     'var y = echo();' +
     '</code></pre>' +
     '<code>echo</code> wird ohne Argument aufgerufen. Dem Parameter <code>x</code> wird so kein Wert zugewiesen, er erhält den Wert <code>undefined</code>. ' +
     ...
     'Eine Funktion, die einen Parameter erwartet, kann immer auch ohne Argument aufgerufen werden. Man sollte sich beim Schreiben von Funktionen also immer überlegen, ' +
     ...
     'zurück. Rufen wir <code>charAt</code> ohne Argument auf, erhält <code>index</code> den Default <code>0</code>. Es wird der Buchstabe an der Stelle <code>0</code> zurückgegeben. ' +
