...
der 8 Schreibweisen Maier, Meier, Mayer, Meyer, Mair, Meir, Mayr und Meyr enthält.
...
// Benutze e?
  ...
  tests: [
    ...
    function() {
      return jshero.testutil.assert_functionReturns('pruefe("Mair")', true);
    },
    ...
    function() {
      return jshero.testutil.assert_functionReturns('pruefe("Mayr")', true);
    },
    ...
    function() {
      return jshero.testutil.assert_functionReturns('pruefe("Meir")', true);
    },
    ...
    function() {
      return jshero.testutil.assert_functionReturns('pruefe("Meyr")', true);
    },

    function() {
      return jshero.testutil.assert_functionReturns('pruefe("aye")', false);
    },
    ...
    function() {
      return jshero.testutil.assert_functionReturns('pruefe("Mayeer")', false);
    }
